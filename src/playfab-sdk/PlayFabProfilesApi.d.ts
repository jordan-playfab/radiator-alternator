...
declare module PlayFabProfilesModule {
    export interface IPlayFabProfiles {
         ...
         */
        SetAvatarUrl(request: PlayFabProfilesModels.SetAvatarUrlRequest, callback: PlayFabModule.ApiCallback<PlayFabProfilesModels.SetAvatarUrlResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
        /**
         ...
         */
        SetDisplayName(request: PlayFabProfilesModels.SetDisplayNameRequest, callback: PlayFabModule.ApiCallback<PlayFabProfilesModels.SetDisplayNameResponse>, customData?: any, extraHeaders?: { [key: string]: string }): void;
        /**
...
declare module PlayFabProfilesModels {
    ...
    export interface SetAvatarUrlRequest extends PlayFabModule.IPlayFabRequestCommon {
    ...
    export interface SetAvatarUrlResponse extends PlayFabModule.IPlayFabResultCommon  {
        /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
        CustomTags?: { [key: string]: string | null };
        /** The entity to perform this action on. */
        Entity?: EntityKey;
