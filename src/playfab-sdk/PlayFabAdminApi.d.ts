...
declare module PlayFabAdminModule {
    export interface IPlayFabAdmin {
         ...
         */
        CreateCloudScriptAzureFunctionsTask(request: PlayFabAdminModels.CreateCloudScriptAzureFunctionsTaskRequest, callback: PlayFabModule.ApiCallback<PlayFabAdminModels.CreateTaskResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
        /**
         * Create a CloudScript task, which can run a CloudScript on a schedule.
         ...
         */
        GetCloudScriptAzureFunctionsTaskInstance(request: PlayFabAdminModels.GetTaskInstanceRequest, callback: PlayFabModule.ApiCallback<PlayFabAdminModels.GetCloudScriptAzureFunctionsTaskInstanceResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
        /**
        ...
        /**
         * Sets key-value pairs in a title data override instance.
...
declare module PlayFabAdminModels {
    ...
    export interface CreateCloudScriptAzureFunctionsTaskRequest extends PlayFabModule.IPlayFabRequestCommon {
        /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
        CustomTags?: { [key: string]: string | null };
        /** Description the task */
        Description?: string;
    ...
    export interface GetCloudScriptAzureFunctionsTaskInstanceResult extends PlayFabModule.IPlayFabResultCommon  {
        /** Parameter of this task instance */
        Parameter?: CloudScriptAzureFunctionsTaskParameter;
    ...
    export interface SetTitleDataAndOverridesRequest extends PlayFabModule.IPlayFabRequestCommon {
        /** List of titleData key-value pairs to set. */
