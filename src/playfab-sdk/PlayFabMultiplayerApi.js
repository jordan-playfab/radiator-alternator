...
PlayFab.MultiplayerApi = {
    ...
    EnablePartiesForTitle: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/Party/EnablePartiesForTitle", request, "X-EntityToken", callback, customData, extraHeaders);
    },
    ...
    GetCognitiveServicesLocales: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/MultiplayerServer/GetCognitiveServicesLocales", request, "X-EntityToken", callback, customData, extraHeaders);
    },

    GetCognitiveServicesToken: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/MultiplayerServer/GetCognitiveServicesToken", request, "X-EntityToken", callback, customData, extraHeaders);
    },
    ...
    RequestParty: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/Party/RequestParty", request, "X-EntityToken", callback, customData, extraHeaders);
    },
