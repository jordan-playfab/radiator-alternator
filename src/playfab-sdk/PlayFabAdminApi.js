...
PlayFab.AdminApi = {
    ...
    CreateCloudScriptAzureFunctionsTask: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/Admin/CreateCloudScriptAzureFunctionsTask", request, "X-SecretKey", callback, customData, extraHeaders);
    },
    ...
    GetCloudScriptAzureFunctionsTaskInstance: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/Admin/GetCloudScriptAzureFunctionsTaskInstance", request, "X-SecretKey", callback, customData, extraHeaders);
    },
