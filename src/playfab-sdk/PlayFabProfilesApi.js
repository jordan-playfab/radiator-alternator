...
PlayFab.ProfilesApi = {
    ...
    SetAvatarUrl: function (request, callback, customData, extraHeaders) {
        return PlayFab._internalSettings.ExecuteRequestWrapper("/Profile/SetAvatarUrl", request, "X-EntityToken", callback, customData, extraHeaders);
    },
