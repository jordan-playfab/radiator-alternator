...
exports.AddFriend = function (request, callback) {
  ...
  PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/Server/AddFriend", request, "X-SecretKey", PlayFab.settings.developerSecretKey, function (
    error,
    result,
  ) {
    if (callback != null) {
...
exports.BanUsers = function (request, callback) {
  ...
  PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/Server/BanUsers", request, "X-SecretKey", PlayFab.settings.developerSecretKey, function (
    error,
    result,
  ) {
    if (callback != null) {
...
exports.GetTime = function (request, callback) {
  ...
  PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/Server/GetTime", request, "X-SecretKey", PlayFab.settings.developerSecretKey, function (
    error,
    result,
  ) {
    if (callback != null) {
...
exports.RevokeBans = function (request, callback) {
  ...
  PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/Server/RevokeBans", request, "X-SecretKey", PlayFab.settings.developerSecretKey, function (
    error,
    result,
  ) {
    if (callback != null) {
...
exports.UpdateBans = function (request, callback) {
  ...
  PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/Server/UpdateBans", request, "X-SecretKey", PlayFab.settings.developerSecretKey, function (
    error,
    result,
  ) {
    if (callback != null) {
