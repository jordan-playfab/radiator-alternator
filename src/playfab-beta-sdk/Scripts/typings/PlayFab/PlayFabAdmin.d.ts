declare module PlayFabAdminModule {
    export interface IPlayFabAdmin {
        ...
        CreateCloudScriptAzureFunctionsTask(
            request: PlayFabAdminModels.CreateCloudScriptAzureFunctionsTaskRequest | null,
            callback: PlayFabModule.ApiCallback<PlayFabAdminModels.CreateTaskResult> | null,
        ): void;
        // Create a CloudScript task, which can run a CloudScript on a schedule.
        ...
        GetCloudScriptAzureFunctionsTaskInstance(
            request: PlayFabAdminModels.GetTaskInstanceRequest | null,
            callback: PlayFabModule.ApiCallback<PlayFabAdminModels.GetCloudScriptAzureFunctionsTaskInstanceResult> | null,
        ): void;
